  ...
  return (
    <header style={{ borderBottom: "1px solid #1e2d42", padding: "0 16px", display: "flex", alignItems: "center", justifyContent: "space-between", background: "rgba(10,14,26,0.95)", position: "sticky", top: 0, zIndex: 100, height: 44 }}>
      ...
      <div className="header-actions" style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <button className="header-priority-btn header-hide-sm" onClick={toggleFullscreen} style={{ padding: "4px 10px", borderRadius: 4, border: "1px solid #1e2d42", background: isFullscreen ? "rgba(74,111,165,0.12)" : "transparent", color: isFullscreen ? "#7ab3e0" : "#3a5570", cursor: "pointer", fontSize: 11, fontFamily: "inherit" }}>{isFullscreen ? "全画面解除" : "全画面"}</button>
