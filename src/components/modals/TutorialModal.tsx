...
const STEPS = [
  ...
  {
    icon: "≡",
    title: "シーン管理 & プロジェクト切替",
    body: "左サイドバーの「＋」ボタンで章・シーンを追加・並び替えできます。ヘッダー左のプロジェクト名から作品棚を開き、複数作品をシーン・設定・AI履歴ごとに切り替えて管理できます。",
  },
  {
    icon: "✎",
    title: "執筆エリア & 自動保存",
  ...
  {
    icon: "◈",
    title: "取込・書き出し & AIアシスタント",
    body: "「取込」で既存の原稿やプロジェクトをAIが自動判別して読み込めます。「書き出し」で各フォーマットに出力。右のAIパネルでは推敲・続き生成などを実行でき、結果はAI履歴に保存されます。",
  },
] as const;
